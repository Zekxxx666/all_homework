...
def menu():
    ...
    if result == 1:
        ...
        os.system("cls")
        min_ram = input_correct("введите минимальное количество оперативной памяти в пк (ГБ):")
        ...
        up_ram = input_correct("введите количество оперативной памяти которую вы хотите добавить:")
        up_RAM(PCs, id, up_ram)
    elif result == 7:
        os.system("cls")
        result_7 = input_correct("как вы хотите удалить пк (1 - по ID, 2 - по индексу):")
        if result_7 == 1:
            id_PC = 0
            os.system("cls")
        ...
        os.system("cls")
        har = input_correct("введите минимальную характеристику видеокарте (ГБ видеопамяти):")
        compare_GPU(PCs, har)
    else:
        os.system("cls")
        GAME_RUN = False
